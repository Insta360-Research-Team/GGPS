...
> **敬请期待！** 我们将对外提供一款基于 **Unreal Engine 的 3DGS 渲染插件**，让你在渲染引擎内直接使用自己重建的模型。免费版（带水印）待批准后公布；付费版（一次买断，无水印）随后提供链接。

- [x] **2026-07-09** — 提供完整的训练代码。
- [x] **2026-07-15** — 提供 Pano360 数据集。
- [ ] **2026 年 7 月下旬** — 提供两个全景 `.ply` 模型，供复现验证。
- [ ] **免费版（带水印）渲染插件** — 免费版待批准后公布；付费版（一次买断，无水印）随后提供链接。
